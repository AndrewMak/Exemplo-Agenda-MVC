...
namespace ExemploAgenda.Controllers
{
    public class PessoasController : Controller
    {
        ...
        {
            return View(await db.Pessoas.Include(x => x.Telefones).Include(p => p.Enderecos).ToListAsync());
        }
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdPessoa,Nome,SobreNome,DataNascimento,Status")] Pessoa pessoa)
        {
